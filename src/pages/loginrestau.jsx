  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        // Nouvel utilisateur Google - créer un profil temporaire
        await setDoc(doc(db, 'usersrestau', user.uid), {
          name: user.displayName || 'Utilisateur Google',
          email: user.email,
          role: 'pending', // Rôle en attente d'attribution
          active: false,
          loginMethod: 'google',
        ...
        setErrorMessage("Compte Google détecté mais aucun rôle admin attribué. Contactez l'administrateur pour obtenir les accès.");
      }
    } catch (error) {
      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-md p-6">
        ...
        <div className="mt-6">
          <button
            ...
            className="inline-flex w-full items-center justify-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-700 font-medium shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
